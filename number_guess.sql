...
ALTER SEQUENCE public.users_info_user_id_seq OWNED BY public.users.user_id;
...
ALTER TABLE ONLY public.users ALTER COLUMN user_id SET DEFAULT nextval('public.users_info_user_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.users_info_user_id_seq', 1, false);


--
-- Name: users users_info_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
